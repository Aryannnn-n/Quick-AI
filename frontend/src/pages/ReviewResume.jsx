  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start gap-4 text-slate-700 dark:text-gray-300">
      ...
      >
        ...
        <p className="mt-6 text-sm font-medium text-gray-900 dark:text-white">Upload Resume</p>
        <input
          required
          type="file"
        ...
        <p className=" text-xs font-light text-gray-500 dark:text-gray-400 mt-1 mb-5">
          Supports only PDF formats.
        </p>

        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 text-sm rounded-lg cursor-pointer">
          {loading ? (
