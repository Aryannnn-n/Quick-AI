    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start gap-4 text-slate-700 dark:text-gray-300">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Remove Object</h1>
        </div>
        ...
        <input
          ...
          className="w-full px-3 p-2 mt-2 outline-none text-sm rounded-md border border-gray-300 dark:border-gray-700 dark:bg-[#0a0a0a] text-gray-500 dark:text-gray-400"
        />

        <p className="mt-4 text-sm font-medium text-gray-900 dark:text-white">Describe Object To Remove</p>
        <textarea
          required
          rows={4}
          value={object}
        ...
        <p className=" text-xs font-light text-gray-500 dark:text-gray-400 mt-0 mb-5">
      ...
      <div className="w-full max-w-lg p-4 bg-white dark:bg-[#111111] rounded-lg flex flex-col border border-gray-200 dark:border-gray-800 min-h-96">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Processed Image</h2>
        </div>
